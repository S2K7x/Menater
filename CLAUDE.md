...
secondary mentions (≥ 3). That is the test that counts: a palette transposed
straight from a poster gives ravishing, unreadable pastels — Attck's failure red
had fallen to **2.5:1**, on the screen that depends on it most. It also revealed
an original defect: the historic theme's `--faint` was at 2.77:1 on panels.
